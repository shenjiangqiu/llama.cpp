...
fn count_continues_steps<const SRC_A_BITS: u8, const SRC_B_BITS: u8>(
    ...
    return a_merged_bits.count_ones() * b_merged_bits.count_ones();
}
...
impl<const WIDTH: u16> RealSim<WIDTH> {
    ...
    pub fn run<const SRC_A_BITS: u8, const SRC_B_BITS: u8>(
        ...
        // info!(
        //     "Running real simulation with width a:{}, b:{},width: {}, lenghth: {}",
        //     SRC_A_BITS,
        //     SRC_B_BITS,
        //     WIDTH,
        //     src_a.len()
        ...
        let steps = src_a.len() / WIDTH as usize;
        ...
        let all_steps = chunk_a
            ...
            .sum::<u32>();
        let max_steps = (SRC_A_BITS * SRC_B_BITS) as u32;
        let max_steps = max_steps * steps as u32;
        return Report {
            all_steps,
            max_steps,
        };
